...
class __TwigTemplate_274e3a8221528375675f1ede15074418bb5ece81341f2c20dcf3027b6ec769c0 extends \Twig\Template
{
    ...
    <div class=\"list-type\">
        ...
        echo "                </div>
            ...
            <div class=\"article tipo\">
                ...
                ";
        // line 204
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_var_dump($this->env, $context, [0 => $this->sandbox->ensureToStringAllowed(($context["data"] ?? null))]), "html", null, true);
        echo "
                    ";
        // line 205
        if ( !(null === ($context["tipo"] ?? null))) {
            // line 206
            echo "                        ";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_var_dump($this->env, $context, [0 => $this->sandbox->ensureToStringAllowed(($context["tipo"] ?? null))]), "html", null, true);
            echo "
                    ";
        }
        // line 208
    ...
    {
        return new Source("", "modules/custom/manuscrito/templates/search.html.twig", "/Applications/MAMP/htdocs/Global-Rheumatology/modules/custom/manuscrito/templates/search.html.twig");
    }
}
