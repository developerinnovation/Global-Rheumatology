...
namespace Drupal\ngt_license\Plugin\Block;

use Drupal\Component\Transliteration\TransliterationInterface;
use Drupal\Core\Form\FormStateInterface;
use Drupal\Core\Session\AccountInterface;
use Drupal\ngt_license\Plugin\Config\Block\LicenseBlockClass;
...
/**
 * Provides a 'LicenseBlock' block.
 *
 * @Block(
 *  id = "global_rehumatology_license",
 *  admin_label = @Translation("Texto para licencias"),
 * )
 */
class LicenseBlock extends BlockBase implements ContainerFactoryPluginInterface{
    /**
     * @var \Drupal\ngt_license\Plugin\Config\Block\LicenseBlockClass
     */
     ...
     * @param \Drupal\ngt_license\Plugin\Config\Block\LicenseBlockClass $configurationInstance
     */
    public function __construct(array $configuration, $plugin_id, $plugin_definition, LicenseBlockClass $configurationInstance) {
    ...
    public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
        return new static(
            ...
            $plugin_id,
            $plugin_definition,
            $container->get('ngt_license.license')
        );
    }
